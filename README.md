...
Выбор сохраняется в текущей сессии, включая reload и resume. Команда не принимает
лишние аргументы - состояние остаётся как было.
...
Расширение добавляет стиль только к естественному тексту ответов. Вызовы инструментов,
код, команды, идентификаторы, ошибки, структурированный вывод, коммиты, PR и документация
остаются без мата. Security и необратимые операции - тоже без шуток.
